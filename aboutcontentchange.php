      ...
      <div class="contact_form">
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea name="message" id="message" class="form-control" placeholder="Please enter the description here" value="<?php echo (($about_data['message'] != "") ? $about_data['message'] : ""); ?>" required>
                            </textarea>
          </div>
          <?php
