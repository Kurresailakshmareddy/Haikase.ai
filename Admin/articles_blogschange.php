    ...
    <div class="row">
      ...
      <div class="contact_form">
        <form method="post" enctype="multipart/form-data">
          ...
          ?>
            <button class="newsbtn" name="update-article" value="add-article">Update Article</button>
          <?php } else { ?>
            <button class="newsbtn" name="add-article" value="add-article">Add Article</button>
          <?php } ?>
